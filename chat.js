...
async function friendRequestAction(
    notification,
    accepted
) {
...
async function handleIncomingNotification(
    ...
    // Если мы уже находимся
    // в этом диалоге — не показываем
    ...
    if (
        ...
        await markDatabaseNotificationReadDirect(
            notification.id
        );
